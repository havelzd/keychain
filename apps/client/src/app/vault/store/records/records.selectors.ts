...
export const selectRecordsLoaded = createSelector(
    selectRecordsState,
    (state: RecordsState) => state.loaded,
);
...
export const selectAllRecords = createSelector(selectRecordsState, (state: RecordsState) =>
    selectAll(state),
);

export const selectRecordsEntities = createSelector(selectRecordsState, (state: RecordsState) =>
    selectEntities(state),
);

export const selectSelectedId = createSelector(
    selectRecordsState,
    (state: RecordsState) => state.selectedId,
);
